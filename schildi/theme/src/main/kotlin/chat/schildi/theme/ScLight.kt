...
internal val sclMaterialColorScheme = lightColorScheme(
    ...
    background = scl_bgDarker,
    onBackground = scl_fgPrimary,
    surface = scl_bgDarker,
...
internal val sclSemanticColors = SemanticColors(
    ...
    bgSubtlePrimary = scl_bg,
    bgSubtleSecondary =  scl_bgFloating,
    ...
    borderInteractivePrimary = scl_divider, // TODO?
    borderInteractiveSecondary = scl_divider, // TODO?
    borderInteractiveHovered = scl_divider, // TODO?
